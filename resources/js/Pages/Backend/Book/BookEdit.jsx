...
export default function ({users, categories, book, elementCategories}) {
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(
            route(`backend.book.update`, book.id),
            {
                _method: 'put',
                ...data,
                image: data.image,
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <ToolTipWidget
                                    message={trans('book_price_instruction')}
                                />
                            ...
                            {/* qty */}
                            <div className="sm:col-span-2 has-tooltip hidden">
                                <label
                                    htmlFor="qty"
                                    className={`block   text-gray-800`}
                                >
                                ...
                                <ToolTipWidget
                                    message={trans('book_qty_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.qty && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('book_sku_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.sku && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans('book_weight_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.weight && (
                                        <div className={`text-red-900`}>
                        ...
                        <FormSection>
                            ...
                            <div className="sm:col-span-full has-tooltip hidden">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'book_embedded_notes_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.embedded && (
                        ...
                        <FormSection title={trans('more_details')}>
                            {isAdminOrAbove && (
                                <>
                                    ...
                                    {/* check stock */}
                                    <fieldset className="mt-1 col-span-1 has-tooltip hidden">
                                        <div>
                                            <legend
                                                className={`text-base  text-gray-900`}
                                            >
                            ...
                            <fieldset className="mt-1 has-tooltip col-span-1">
                                ...
                                <ToolTipWidget
                                    message={trans('book_download_instruction')}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                                        {errors.download && (
                            ...
                            <fieldset className="mt-1 has-tooltip col-span-1">
                                ...
                                <ToolTipWidget
                                    message={trans('book_free_instruction')}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                                        {errors.free && (
                    ...
                    >
                        <FormSection title={trans('more_details')}>
                            ...
                            <div className="sm:col-span-3 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('book_notes_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.notes_ar && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('book_caption_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.caption_ar && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'book_delivery_time_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'book_video_url_one_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'book_video_url_two_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <ToolTipWidget
                                    message={trans('book_end_sale_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    <span
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <ToolTipWidget
                                    message={trans('book_qr_instruction')}
                                />
                                <p
                                    className={` text-red-500 rtl:text-left ltr:text-right`}
                                >
                        ...
                        <FormSection>
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('book_is_available_message')}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                                        {errors.is_available && (
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'book_direct_purchase_instruction'
                                    )}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('book_on_new_instruction')}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                                        {errors.on_new && (
