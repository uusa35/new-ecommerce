...
export default function ServiceEdit({
    ...
    const submit = (e) => {
        e.preventDefault();
        Inertia.post(
            route(`backend.service.update`, service.id),
            {
                _method: 'put',
                ...data,
                image: data.image,
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <ToolTipWidget
                                    message={trans('service_price_instruction')}
                                />
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('service_sku_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.sku && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans('service_user_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.user_id && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-3 has-tooltip mt-5">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_main_image_instruction'
                                    )}
                                />
                                <p
                    ...
                    >
                        <FormSection title={trans('more_details')}>
                            <div className="sm:col-span-3 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_description_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-3 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans('service_notes_instruction')}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.notes_ar && (
                                        <div className={`text-red-900`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_delivery_time_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_video_url_one_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_video_url_two_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <p className={`mt-2  text-gray-500`}>
                                    ...
                                    >
                                        {trans('current_date')} :{' '}
                                        {moment(service.start_sale).format(
                                            'DD/MM/Y  -|- hh:mm a'
                                        )}
                                    </span>
                                    {errors.start_sale && (
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_start_sale_instruction'
                                    )}
                                />
                                <p className={`mt-2  text-gray-500`}>
                                    <span
                                    ...
                                    >
                                        {trans('current_date')} :{' '}
                                        {moment(service.end_sale).format(
                                            'DD/MM/Y  -|- hh:mm a'
                                        )}
                                    </span>
                                    {errors.end_sale && (
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <ToolTipWidget
                                    message={trans('service_qr_instruction')}
                                />
                                <p
                                    className={` text-red-500 rtl:text-left ltr:text-right`}
                                >
                        ...
                        <FormSection title={trans('more_details')}>
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_wrap_as_gift_instruction'
                                    )}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_direct_purchase_instruction'
                                    )}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
                            ...
                            <fieldset className="mt-1 col-span-1 has-tooltip">
                                ...
                                <ToolTipWidget
                                    message={trans(
                                        'service_is_hot_deal_instruction'
                                    )}
                                />
                                <div>
                                    <p className={`mt-2  text-gray-500`}>
