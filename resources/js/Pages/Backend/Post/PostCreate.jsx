...
export default function PostCreate({users, categories}) {
                ...
                >
                    ...
                    <FormSection title={`${trans('other_elements')}`}>
                        ...
                        <div className="sm:col-span-full has-tooltip">
                            ...
                            <ToolTipWidget
                                message={trans('categories_instruction')}
                            />
                            <p className={`mt-2  text-gray-500`}>
                                {errors.categories && (
                                    <div className={`text-red-900`}>
                    ...
                    <FormSection title={trans('more_details')}>
                        ...
                        <fieldset className="mt-1 has-tooltip col-span-1">
                            ...
                            <ToolTipWidget
                                message={trans('has_attributes_instruction')}
                            />
                            <div>
                                <p className={`mt-2  text-gray-500`}>
                        ...
                        <fieldset className="mt-1 has-tooltip col-span-1">
                            ...
                            <div className="mt-4 space-y-4">
                                <div className="flex items-center">
                                    <input
                                        ...
                                        type="radio"
                                        value={1}
                                        defaultChecked={data.show_attribute}
                                        className={`mx-5 focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300`}
                                    />
                                    <label
                            ...
                            <ToolTipWidget
                                message={trans('show_attribute_instruction')}
                            />
                            <div>
                                <p className={`mt-2  text-gray-500`}>
