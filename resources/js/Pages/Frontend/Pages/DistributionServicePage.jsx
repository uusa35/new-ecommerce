...
var __html = require('./distribution.html');
                    ...
                    >
                        ...
                        <div className="flex w-full justify-center ">
                            <Link
                                ...
                                className="rounded-md shadow-lg text-lg p-5 mt-10 bg-gray-600 text-white text-center"
                            >
                                {trans('distribution_message')}
                            </Link>
                        </div>
                    </section>
                </div>
